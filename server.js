...
app.use(session({
  ...
  cookie: {
    secure: process.env.NODE_ENV === 'production', // Se NODE_ENV não existe, isso é 'false', o que é correto para HTTP dev
    httpOnly: true,
    maxAge: 24 * 60 * 60 * 1000
  }
}));

// LOG ADICIONAL PARA VERIFICAR NODE_ENV E CONFIGURAÇÃO DO COOKIE SECURE
